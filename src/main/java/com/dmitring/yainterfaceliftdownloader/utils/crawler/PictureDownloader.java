...
public class PictureDownloader {
    private static final Logger log = Logger.getLogger(PictureDownloader.class.getName());

    private final UrlStreamProvider inputStreamProvider;
    private final PictureStreamProvider outputStreamProvider;

    @Autowired
    public PictureDownloader(UrlStreamProvider inputStreamProvider, PictureStreamProvider outputStreamProvider) {
